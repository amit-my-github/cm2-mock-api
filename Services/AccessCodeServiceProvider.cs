...
namespace Asp.Net.Core.WebApi.CrudOperations.Services
{
    public static class AccessCodeServiceProvider
    {
        ...
        public static int Create(AccessCodeItem accessCode)
        {
            var connectionString = GetConnection();
        ...
        public static AccessCodeItem? GetById(int id)
        {
            ...
            return res.AccessCodes.FirstOrDefault();
        ...
        public static bool Update(int Id, AccessCodeItem accessCode)
        {
            ...
            using (var objDd = new MsSqlClient(connectionString))
            {
                ...
                objDd.AddParameter("@DateCreated", string.IsNullOrEmpty(accessCode.CreatedDate) ? DBNull.Value : accessCode.CreatedDate);
                objDd.AddParameter("@Lastmodified", string.IsNullOrEmpty(accessCode.LastModified) ? DBNull.Value : accessCode.LastModified);
        ...
        private static int CreateAccessCode(string connectionString, AccessCodeItem accessCode)
        {
            if (accessCode != null)
            {
                using (var objDd = new MsSqlClient(connectionString))
